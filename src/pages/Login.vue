...
.login-page {
    --login-bg: #faf6f0;
    --login-paper: rgba(255, 254, 251, 0.92);
    --login-ink: #1c1917;
    --login-muted: #78716c;
    --login-accent: #2d6a4f;
    --login-accent-hover: #1b4332;
    --login-ring: rgba(45, 106, 79, 0.22);
...
.login-card {
    ...
    box-shadow:
        ...
        0 8px 16px -12px rgba(45, 106, 79, 0.12);
...
.login-submit.van-button--primary {
    ...
    box-shadow: 0 4px 14px -4px rgba(45, 106, 79, 0.55);
    transition:
        transform 0.2s ease,
